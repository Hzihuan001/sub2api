...
- Application version: `0.2.8-station.2`
- Source tag: `custom-station-0.2.8.2`
- Container tag: `ghcr.io/<fork-owner>/sub2api:0.2.8-station.2`
...
2. Push only `codex/v0.2.8-station-minimal` and tag `custom-station-0.2.8.2`.
