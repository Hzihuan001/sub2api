...
- Application version: `0.2.8-station.1`
- Source tag: `custom-station-0.2.8.1`
- Container tag: `ghcr.io/<fork-owner>/sub2api:0.2.8-station.1`
...
2. Push only `codex/v0.2.8-station-minimal` and tag `custom-station-0.2.8.1`.
