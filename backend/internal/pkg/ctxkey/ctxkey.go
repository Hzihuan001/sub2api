...
const (
	...
	// ResellerRequestSource marks internal reseller traffic such as account tests.
	// User gateway requests leave this unset and are classified as user traffic.
	ResellerRequestSource Key = "ctx_reseller_request_source"
