...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// The first custom.2 staging attempt applied the original Kiro-only constraint
	// before stopping on a later immutable migration. The current file is an
	// upgrade-safe superset for databases that discover 145 late; accept only the
	// exact checksum recorded by that staging attempt.
	"145_allow_kiro_user_platform_quotas.sql": newMigrationChecksumCompatibilityRule("be170f3bdf21d8843e674c30a99b48bdf7202133b9651a60ec7f7e3d7b1939b8", "bc174c2b9dd244f10090a322bb685c8fd6c3e8050777a07b3c92c08b1d8cae94"),
