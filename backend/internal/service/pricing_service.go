...
var (
	...
	claudeOpus55FallbackPricing = &LiteLLMModelPricing{
		...
		CacheReadInputTokenCost: 0.2e-6, InputCostPerTokenPriority: 8e-6,
		OutputCostPerTokenPriority: 40e-6, CacheCreationInputTokenCostPriority: 10e-6,
		CacheReadInputTokenCostPriority: 0.4e-6, SupportsServiceTier: true,
