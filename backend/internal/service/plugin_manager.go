...
// ProvidePluginManager wires the sensitive account directory at construction
// time so generated dependency-injection code remains reproducible. Keeping
// this setup in the provider avoids hand-editing wire_gen.go after upgrades.
func ProvidePluginManager(repo PluginRepository, encryptor SecretEncryptor, cfg *config.Config, hostInfo PluginHostInfo, kvStore PluginKVStore, directory PluginAccountDirectory) *PluginManager {
