...
func TestOllamaProbeCallback_StaleLongDoesNotOverrideNewShort(t *testing.T) {
	...
	// Keep the newer cooldown clearly ahead of the scheduler's immediate 5s
	// callback. On Windows, a tight boundary can race the timer and make the
	// stale result appear current intermittently.
