...
func (s *GatewayService) ForwardAsChatCompletions(
	...
	// 13. Bill the effort actually sent to Anthropic. Client-side Chat
	// Completions spelling (xhigh) is converted to the Anthropic max tier by
	// the protocol bridge; thinking.type alone is not an effort level.
