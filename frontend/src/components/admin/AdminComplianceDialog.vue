...
const documentUrl = computed(() => {
  if (getLocale() === 'zh') {
    return complianceStore.status?.document_url_zh || 'https://moshu.cloud/legal/admin-compliance.zh.md'
  }
  return complianceStore.status?.document_url_en || 'https://moshu.cloud/legal/admin-compliance.en.md'
})
