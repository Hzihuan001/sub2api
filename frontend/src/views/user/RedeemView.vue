        ...
        <div class="p-6">
          ...
          <div class="mt-4 flex flex-wrap items-center justify-between gap-3 text-sm">
            ...
            <label>
              ...
              <Select v-model="historyPageSize" class="w-20" size="sm" :options="historyPageSizeOptions"
                :disabled="loadingHistory || submitting" :aria-label="t('pagination.perPage')"
                @update:model-value="fetchHistory(1)" />
            </label>
            <button
