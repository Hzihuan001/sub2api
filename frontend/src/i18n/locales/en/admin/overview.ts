export default {
    ...
    groups: {
      ...
      codexModelsManifest: {
        title: 'Pinned Upstreams for Model Lists',
        hint: 'When enabled, ordinary model lists and Codex Model Manifest are discovered from the pinned upstreams first, then merged and filtered using upstream mappings and the group model list. Rate-limited or overloaded pinned upstreams are still used.',
        enable: 'Fetch model lists with specific upstreams',
