export default {
    accounts: {
      ...
      opencodeGo: {
        ...
        panelHint: '显示上游 OpenCode Go 账号报告的用量窗口；可手动刷新，也可在开启后自动刷新。',
        notRefreshed: '尚未刷新',
        refreshNow: '刷新用量',
        autoRefresh: '自动刷新用量',
        autoRefreshHint: '只有账号开关和全局开关同时启用时才会定时刷新。',
      ...
      openaiReferral: {
        ...
        workspace: '邀请同事',
        email: '接收方邮箱',
        consent: '我已获得此人的同意，可以向其发送邀请。',
        send: '发送邀请',
        sending: '发送中…',
        sent: '已向 {email} 发送邀请',
        queryHint: '点击查询剩余邀请数',
        checkedAt: '已于 {time} 查询，点击刷新。',
        unavailable: '邀请不可用，可能未满足资格要求或已达到上限。',
        invalidEmail: '请输入一个有效的邮箱地址。',
        rejected: '邀请被拒绝，请检查邮箱和优惠资格。',
        alreadyInvited: '该邮箱已有邀请，请在 Codex 中查看状态。',
        rateLimited: '已达到邀请频率或容量限制，请稍后重试。',
        sendUnknown: '邀请结果未知，请在 Codex 中确认状态后再决定是否重试。',
        programChanged: '账号的邀请计划发生变化，请刷新资格后再发送。',
        consentRequired: '请先确认已获得接收方同意。',
        shadowHint: '请从父账号发送邀请。',
        cacheFailed: '已获取实时容量，但缓存保存失败，请重新查询。',
        refreshFailed: '邀请已发送，但剩余容量刷新失败，请重新查询。'
      },
      openaiQuotaReset: {
        count: '次数',
        points: '点数',
